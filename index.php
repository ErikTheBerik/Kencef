...
<html lang="en">
  <head>
    ...
    <meta name="theme-color" content="#6ea097">
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="css/style.css?date=270920_1">
    ...
    <div class="container-fluid" id="MainWindow">
      <div class="row" id="top_div">
        ...
        <div class="col-sm-4 col-12 BottomZone">
          ...
          <div id="kencef_video" class="col-12" style="padding-right: 3vmin; margin-top: -10vh;">
            <iframe 
